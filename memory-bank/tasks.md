...
**Статус:** Планирование завершено (PLANED) - проработка комбинации вариантов 2 и 3 для раздела "Список задач"
...
- [ ] **Этап 1: Создание шаблона строки задачи**
  ...
  - [ ] Создать шаблон с пояснениями
  - [ ] Добавить примеры использования шаблона

- [ ] **Этап 2: Преобразование таблицы в маркированный список**
  - [ ] Преобразовать таблицу в маркированный список
  - [ ] Использовать формат: `* [X] **task_id** | <STATUS> | Название`
  - [ ] Определить чекбоксы для всех задач

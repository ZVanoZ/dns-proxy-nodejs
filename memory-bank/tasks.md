...
- [ ] 1.1–1.3: сбор информации, артефакты в `<task-folder>/docs/`
- [ ] 2.1–2.6: проектирование (конфиг, опции, кеш, App, тесты, запуск)
- [ ] 3.1: конфигурация (app.ini.dist во всех окружениях)
- [ ] 3.2: Options + App (два сокета, общий обработчик)
- [ ] 3.3: тесты и test.config.ini
- [ ] 3.4: main.ts, Docker/docker-compose при необходимости
- [ ] 3.5: документация

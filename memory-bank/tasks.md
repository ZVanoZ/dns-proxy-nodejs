...
**Статус:** REFLECT - Рефлексия завершена, готово к архивированию
...
- Задача описана в `docs/tasks/2026/01/21/12-02-00/index.md`
...
- Текущие проблемы документации:
  - В README.md смешана информация (vanzan01, RAW секция, устаревшие инструкции)
  - Секция "Как запустить?" устарела
  - Вспомогательные файлы (how-to-run-in-linux.md, run-app.sh) требуют реорганизации
  - Документация DNS в docs/dns/ должна быть в docs/reference/

### Анализ задачи

**Текущая ситуация:**
- README.md содержит смешанную информацию (vanzan01, RAW, устаревшие инструкции)
- Документация DNS находится в `docs/dns/`, должна быть в `docs/reference/dns/`
- Инструкции по запуску устарели и разбросаны по разным файлам
- Вспомогательные файлы (how-to-run-in-linux.md, run-app.sh) требуют реорганизации

**Цели:**
1. Очистить README.md от вспомогательной информации
2. Перенести документацию DNS в правильное место (`docs/reference/dns/`)
3. Актуализировать инструкции по запуску
4. Структурировать папку /docs согласно лучшим практикам
5. Создать правильную структуру: guides/, reference/, archive/, development/

**Технические требования:**
- Следовать рекомендациям из `answer.md` (geminy)
- README.md должен содержать только суть, Quick Start и ссылки
- Документация должна быть структурирована по принципу разделения интересов

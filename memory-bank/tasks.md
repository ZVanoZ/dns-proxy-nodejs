...
| 2.6 | Запуск: один порт для обоих семейств — дополнительный порт не открывать. Docker: при необходимости добавить поддержку IPv6 в docker-compose (порты/сети). |
...
- [x] 3.4: main.ts без изменений; Docker без изменений
- [x] 3.5: документация (readme — раздел IPv4/IPv6)

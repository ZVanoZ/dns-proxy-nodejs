...
**Статус:** Планирование завершено (PLANED) - вынос правил ведения задач в отдельный файл
...
- [ ] **Этап 1: Создание файла `docs/tasks/rules.md`**
  - [ ] Создать файл `docs/tasks/rules.md`
  - [ ] Добавить заголовок и описание
  - [ ] Перенести раздел "Правила работы с задачами"
  - [ ] Перенести раздел "Шаблон строки задачи"
  - [ ] Перенести примечания из конца `docs/tasks/index.md`
  - [ ] Проверить структуру и форматирование

- [ ] **Этап 2: Обновление файла `docs/tasks/index.md`**
  - [ ] Добавить ссылку на `rules.md` в начале файла
  - [ ] Добавить явное указание для Cursor AI о необходимости сначала читать правила
  - [ ] Удалить раздел "Правила работы с задачами"
  - [ ] Удалить раздел "Шаблон строки задачи"
  - [ ] Удалить примечания в конце файла
  - [ ] Оставить только раздел "Список задач"
  - [ ] Проверить, что файл содержит только необходимые элементы

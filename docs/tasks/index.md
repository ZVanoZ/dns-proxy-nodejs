...
* [ ] **task20260217164400** | CREATED | Выполнить диагностику окружения IPv6 
* [ ] **task20260303172400** | CREATED | Исправить ошибки: флаг QR; Обработка PTR-запросов; Фильтрация типов
* [ ] **task20260304105600** | CREATED | Разобраться со сборкой для PROD
